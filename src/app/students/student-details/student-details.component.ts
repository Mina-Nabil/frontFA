...
export class StudentDetailsComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      Clss:       [null,                          Validators.compose([Validators.required])],
      ...
      if(this.studentObj.STUD_ID != null){
        this.isEdit = true;
    ...
    modifyStudent(){
        ...
        STUD_FAV_POS: this.form.controls['Position'].value.POST_ID,
        STUD_CLSS_ID: this.form.controls['Clss'].value.CLSS_ID,
      ...
      // if(!this.isEdit){
        this._studentsService.addStudent(this.studentObj).subscribe(data => {
                                                              ...
                                                              console.log(this.newstudentObj);
      ...
      // }else{
      //   this._classService.editClass(this.studentObj).subscribe(data => {
      //                                                         this.newstudentObj = data;
      //                                                         if(this.newstudentObj.CLSS_NAME != this.studentObj.CLSS_NAME)
      //                                                         this.declareError('Mismatch Error');
      //                                                         else
      //                                                         this.declareSuccess();
      //                                                       },
